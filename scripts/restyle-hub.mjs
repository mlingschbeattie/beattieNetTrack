...
const hubIndexPath = 'c:/Users/mlingsch/cluster/hub/src/pages/index.astro';
...
const CATEGORY_META = {
  'curriculum': { label: 'Core Curriculum & CIS', icon: '🎓', color: '#3b82f6', bg: 'rgba(59, 130, 246, 0.12)' },
  'simulators': { label: 'Interactive Ranges & Simulators', icon: '⚡', color: '#10b981', bg: 'rgba(16, 185, 129, 0.12)' },
  'ai-tools': { label: 'AI Studio & Technical Tools', icon: '✨', color: '#8b5cf6', bg: 'rgba(139, 92, 246, 0.12)' },
  'interactive': { label: 'Games, Quests & Challenges', icon: '🎮', color: '#f59e0b', bg: 'rgba(245, 158, 11, 0.12)' }
};
...
fs.writeFileSync(hubIndexPath, newHubContent);
console.log('Restyled Hub index.astro with modern categorized glassmorphism');
`;

fs.writeFileSync('c:/Users/mlingsch/beattieNetTrack/scripts/restyle-hub.mjs', newHubContent);
