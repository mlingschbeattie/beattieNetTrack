...
console.log('Successfully updated Hub index.astro with clean monochrome SVG icons and slate theme');
`;

fs.writeFileSync('c:/Users/mlingsch/beattieNetTrack/scripts/update-hub-clean.mjs', hubTemplate);
